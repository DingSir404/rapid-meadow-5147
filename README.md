...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-meadow-5147
```

A live public deployment of this template is available at [https://rapid-meadow-5147.templates.workers.dev](https://rapid-meadow-5147.templates.workers.dev)
